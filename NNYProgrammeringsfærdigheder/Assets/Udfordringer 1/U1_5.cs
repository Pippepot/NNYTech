...
public class U1_5 : MonoBehaviour
{
    ...
    // Hvis et tal til et indeks i a er ulige, er 'svar' til indekset lig med det tal. Ellers er 'svar' til indekset 0
    // Gør brug af for loop til dette
    // Set svaret ind som argument i Dommer.Udfordring('svar her');
    
    // Eventuelle søgeord: 'arrays' 'for loops' 'modulus'
    void Start()
    {
    ...
    #region Hint 1
    // Gør brug af modulus operatoren '%'
    // (Søg evt. på modulus)
    #endregion
